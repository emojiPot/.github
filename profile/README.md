<h1 align="center">AR기반 여행 기록 노트 ✈️</h1>
...
|                                   시스템 구성도                                 |
| :----------------------------------------------------------------------------------------: |
| <img src="https://github.com/user-attachments/assets/cc38f038-6983-4214-8cfe-a44b4a1eee5f" alt="시스템 구성도" width="1000px" /> |

|                              개체-관계 모델(ERD)                               |
| :----------------------------------------------------------------------------: |
| <img src="https://github.com/user-attachments/assets/1624cba3-d19a-45e0-93d3-a5d1e65476a9" alt="개체-관계 모델(ERD)" width="1000px" /> |
